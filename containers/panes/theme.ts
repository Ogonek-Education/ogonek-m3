...
export const singlePane = tv({
  slots: {
    base: "bg-md-sys-color-surface flex flex-col box-border overflow-clip md:rounded-lg",
...
export const supportingPane = tv({
  slots: {
    ...
    supporting:
      "text-md-sys-color-on-surface-container box-border md:w-80 md:sticky md:top-4 order-1 md:order-2 min-w-min md:h-[calc(100dvh-2rem)] overflow-y-scroll overflow-x-visible",
  },
  variants: {
    position: {
      right: {
