...
export const supportingPane = tv({
  slots: {
    ...
    supporting:
      "bg-md-sys-color-secondary-container text-md-sys-color-on-secondary-container box-border rounded-lg p-4 md:w-80 md:sticky md:top-4 md:h-[calc(100dvh-2rem)] md:overflow-auto order-1 md:order-2 min-w-min",
  },
  variants: {
    position: {
      right: {
