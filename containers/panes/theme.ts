...
export const supportingPane = tv({
  slots: {
    ...
    supporting:
      "text-md-sys-color-on-surface-container box-border md:w-80 md:sticky md:top-4 order-1 md:order-2 min-w-min h-[calc(100dvh-2rem)] overflow-y-scroll overflow-x-visible",
  },
  variants: {
    position: {
      right: {
