...
<style>
	.dialogue-base {
		opacity: 0;
		animation: dialogueScrimIn 500ms var(--md-sys-motion-timing-function-emphasized-decel) forwards;
	}

	.dialogue-base.leaving {
		animation: dialogueScrimOut 350ms var(--md-sys-motion-timing-function-emphasized-decel) forwards;
	}
	...
	.dialogue-inner.leaving {
		animation: dialogueOut 500ms var(--md-sys-motion-timing-function-emphasized-decel) forwards;
	}
	...
	.dialogue-inner.leaving .dialogue-buttons {
		animation:
			...
			dialogueOpacityOut 100ms var(--md-sys-motion-timing-function-emphasized-decel) forwards;
	}
