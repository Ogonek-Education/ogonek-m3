...
export const snackbar = tv({
	slots: {
		base: 'rounded-xs relative min-h-12 md:max-h-17 flex z-50 items-center bg-md-sys-color-inverse-surface shadow-elevation-3 pr-2 pl-4 justify-between h-max py-3',
