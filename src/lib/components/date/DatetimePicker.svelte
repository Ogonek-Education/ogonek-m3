<script lang="ts">
	import { Title, VStack, TimeField } from '$lib/components/index.js';
...
<input type="hidden" name="dtstartTime" value={dtstartTime} data-cy="calendar-dtstart-time" />
<input type="hidden" name="dtendTime" value={dtendTime || ''} data-cy="calendar-dtend-time" />
<input type="hidden" name="dtstartTz" value={dtstartTz} data-cy="calendar-dtstart-tz" />
<input type="hidden" name="dtendTz" value={dtendTz} data-cy="calendar-dtend-tz" />
<DateField label="Дата встречи" bind:value={dateString} data-cy="calendar-date" />
<TimeField label="Начало встречи" bind:value={startTimeString} data-cy="calendar-time" />
