...
export const card = tv({
  slots: {
    base: "relative transition-all rounded-xl disabled:opacity-[0.38] disabled:bg-sys-color-surface-variant state-layer before:rounded-xl focus:outline-3 focus:outline-md-sys-color-secondary hover:before:bg-md-sys-color-on-surface/8 px-4",
