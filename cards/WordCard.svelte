...
>
  {#if !isFlipped}
    ...
    <div
      ...
      class="border-fat bg-solid padding-default absolute inset-0 flex items-center justify-center backface-hidden"
    >
  ...
  {:else}
    ...
    <div
      ...
      class="bg-solid border-fat-accent padding-default absolute flex size-full items-center justify-center backface-hidden"
    >
