...
export const notificationTheme = tv({
  slots: {
    base: "gap-default bg-bg-primary rounded-2xl border-2 font-semibold padding-default fixed w-full md:w-auto md:max-w-lg px-3 top-6 left-1/2 -translate-x-1/2 z-50 flex items-center text-center md:text-left",
