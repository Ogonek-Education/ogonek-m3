...
export const snackbar = tv({
  slots: {
    base: "rounded-xs relative min-h-12 max-h-17 flex z-30 items-center bg-md-sys-color-inverse-surface shadow-elevation-3 state-layer hover:before:bg-md-sys-color-inverse-primary/8 pr-2 pl-4 justify-between h-max py-3",
    label:
