...
export const tooltip = tv({
  slots: {
    base: "bg-md-sys-color-surface-container min-w-48 py-3 px-4 flex flex-col gap-3 shadow-elevation-2 rounded-md relative state-layer hover:before:bg-md-sys-color-primary/8 before:rounded-md z-40",
    subhead: "",
    supportingText: "",
